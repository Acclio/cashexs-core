...
<head>
    ...
    <title>Cashexs | Confirmation</title>
                            ...
                            <tr>
                                <td>
                                    <div class="text" style="padding: 0 2.5em; text-align: center;">
                                        ...
                                        <h3>Hello {{ $name ?? 'You' }}, <br> Before we get started, please take a second to make sure we've got your email right. Please use the OTP below to confirm your email address or click on the button below</h3>
                                        <h2> {{ $token ?? '00000' }} </h2>
